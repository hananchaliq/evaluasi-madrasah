...
class SubjectCategoryController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('Admin/SubjectCategories/Index', [
    ...
    {
        return Inertia::render('Admin/SubjectCategories/Create');
    }
    ...
    {
        return Inertia::render('Admin/SubjectCategories/Edit', [
