...
export default function Index({ teachers, filters }) {
    ...
    const handleResetSearch = () => {
        ...
        router.get(route('teachers.index'), {}, { preserveState: true, replace: true });
    };
    ...
    const confirmDelete = () => {
        ...
        deleteForm.delete(route('teachers.destroy', deleteTarget.id), {
            preserveScroll: true,
    ...
    const hasRelatedData = (teacher) =>
        teacher.teaching_assignments_count > 0 ||
        teacher.evaluations_count > 0;
                        ...
                        <div className="flex-1">
                            ...
                            <div className="relative mt-1">
                                ...
                                <TextInput
                                    ...
                                    placeholder="Masukkan nama atau NIP guru..."
                                />
                            </div>
                        </div>
