...
export default function Index({ kelas, tingkatans, filters }) {
    ...
    const handleSearch = (e) => {
        ...
        router.get(
            route('kelas.index'),
            {
                ...
                tingkatan_id: searchForm.data.tingkatan_id || undefined,
            },
    ...
    const handleResetSearch = () => {
        ...
        router.get(route('kelas.index'), {}, { preserveState: true, replace: true });
    };
    ...
    const confirmDelete = () => {
        ...
        deleteForm.delete(route('kelas.destroy', deleteTarget.id), {
            preserveScroll: true,
            onSuccess: () => closeDeleteModal(),
        });
    };

    const hasRelatedData = (item) =>
        item.students_count > 0 || item.teaching_assignments_count > 0;

    const hasActiveFilters = filters.search || filters.tingkatan_id;
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <p className="text-sm text-slate-600">
                            Kelola data kelas berdasarkan tingkatan madrasah.
                        </p>
                    </div>
                    <Link
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
                    ...
                    >
                        <div className="sm:col-span-2 lg:col-span-1">
                            <InputLabel htmlFor="search" value="Cari Kelas" />
                            <div className="relative mt-1">
                                ...
                                <TextInput
                                    ...
                                    placeholder="Nama kelas atau tingkatan..."
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <select
                                id="tingkatan_id"
                                value={searchForm.data.tingkatan_id}
                                onChange={(e) =>
                                    searchForm.setData(
                                        'tingkatan_id',
                                        e.target.value,
                    ...
                    <p className="mt-2 text-sm text-slate-600">
                        ...
                        {deleteTarget && hasRelatedData(deleteTarget) && (
                            <span className="mt-2 block text-red-600">
                                Kelas ini masih memiliki siswa atau penugasan
                                mengajar dan tidak dapat dihapus.
                            </span>
                        )}
                        {deleteTarget && !hasRelatedData(deleteTarget) && (
