...
export default function Create({ nextUrutan }) {
    ...
    return (
        <AdminLayout title="Tambah Pertanyaan Evaluasi">
            <Head title="Tambah Pertanyaan Evaluasi" />

            <div className="mx-auto max-w-2xl">
                <div className="mb-6">
                    <p className="text-sm text-slate-600">
                        Tambahkan pertanyaan baru untuk evaluasi pembelajaran
                        siswa.
                    </p>
                </div>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Contoh: Guru menjelaskan materi dengan jelas dan mudah dipahami."
                                autoFocus
                            />
                            <InputError
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-xs text-slate-500">
                                Urutan menentukan posisi pertanyaan saat
                                evaluasi ditampilkan.
                            </p>
                            <InputError
