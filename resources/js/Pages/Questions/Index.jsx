...
export default function Index({ questions, filters }) {
    ...
    const handleResetSearch = () => {
        ...
        setSelectedIds([]);
        router.get(route('questions.index'), {}, { preserveState: true, replace: true });
    };
    ...
    const confirmDelete = () => {
        ...
        deleteForm.delete(route('questions.destroy', deleteTarget.id), {
            preserveScroll: true,
            onSuccess: () => {
                setSelectedIds((current) =>
    ...
    const confirmBulkAction = () => {
        bulkForm.patch(route('questions.bulk'), {
            preserveScroll: true,
            onSuccess: () => {
                setSelectedIds([]);
                closeBulkModal();
    ...
    const moveQuestion = (questionId, direction) => {
        router.patch(
            route('questions.move', questionId),
            {
                direction,
