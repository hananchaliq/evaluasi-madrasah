...
export default function Index({ tingkatans, filters }) {
    ...
    const handleResetSearch = () => {
        ...
        router.get(route('admin.tingkatans.index'), {}, { preserveState: true, replace: true });
    };
    ...
    const confirmDelete = () => {
        ...
        deleteForm.delete(route('admin.tingkatans.destroy', deleteTarget.id), {
            preserveScroll: true,
        ...
        <AdminLayout title="Tingkatan">
            ...
            <div className="space-y-6">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Link
                        href={route('admin.tingkatans.create')}
