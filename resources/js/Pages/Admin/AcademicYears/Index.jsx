...
export default function Index({ academicYears, filters }) {
    ...
    const confirmDelete = () => {
        ...
        deleteForm.delete(route('admin.academic-years.destroy', deleteTarget.id), {
            preserveScroll: true,
    ...
    return (
        <AdminLayout title="Tahun Akademik">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <p className="text-sm text-slate-600">
                            Kelola tahun akademik madrasah. Hanya satu tahun
                            akademik yang dapat aktif pada satu waktu.
                        </p>
                    </div>
                    <Link
                            ...
                            <tbody className="divide-y divide-slate-200 bg-white">
                                {academicYears.data.length === 0 ? (
                                    <tr>
                                        ...
                                        >
                                            {filters.search
                                                ? 'Tidak ada tahun akademik yang sesuai dengan pencarian.'
            ...
            >
                <div className="p-6">
                    ...
                    <p className="mt-2 text-sm text-slate-600">
                        ...
                        ?
                        {deleteTarget?.semesters_count > 0 && (
                            <span className="mt-2 block text-red-600">
                                Tahun akademik ini masih memiliki{' '}
                                {deleteTarget.semesters_count} semester dan
                                tidak dapat dihapus.
                            </span>
                        )}
                        {deleteTarget?.semesters_count === 0 && (
